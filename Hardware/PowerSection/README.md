...
|| Ihi  | Current sense output for heating element current used for measuring high magnitude currents. Assuming a 15 $m\Omega$ shunt, voltage should be approximately $V_{Ilo} = 0.015 \times 00 \times I_{htr}$. Output is limited to approximately _Vin_. |
